...
<div class="container-fluid" style="padding: 2%">
    ...
    <form id="row_1" class="form">
            ...
            <div class="col-sm-6 col-xs-6 col-lg-6 col-md-6">
                <div class="row" style="float: right">
                    ...
                    <div class="form-group">
                        ...
                        <!-- <input type="month" name="date" class="form-control" placeholder="Enter The Month & Year Respectively"> -->
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row" id='ro' style="border: 1px solid #305881; border-radius: 5px; background-color: #dfdfe5; padding: 1%;">
            <div class="col-sm-6 col-sm-offset-3" style="background-color:white;padding: 1%;border-radius: 25px;">
